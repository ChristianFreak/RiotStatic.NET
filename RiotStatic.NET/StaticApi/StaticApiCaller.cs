using RiotStatic.StaticApi.StaticChampions;
using RiotStatic.StaticApi.StaticItems;
using RiotStatic.StaticApi.StaticMaps;
using RiotStatic.StaticApi.StaticMasteries;
...
namespace RiotStatic.StaticApi
{
    public class StaticApiCaller
    {
        ...
        public async Task<StaticChampion> GetChampionAsync(Region Reg, int Id, ChampionDataStyle? CData = null)
        {
            HttpContent Champion = await GetRequest(Reg.ToString(), DefineUrl("champions/" + Id, CData.ToString()));
